...
- **Status:** In progress — T13.3 Tini OCR pipeline
- **Released version:** 1.5.0
- **Target version:** 1.6.0
- **Started:** 2026-08-21
- **Owner:** danghoangsqtt-sys
- **Next command:** Implement T13.3 real image OCR, review and TXT/Markdown/DOCX export
...
| T13.2 Shared Tini Core lifecycle | Complete — 95 backend tests + lint/build + Electron E2E 8/8 pass |
| T13.3 Tini OCR pipeline | In progress |
