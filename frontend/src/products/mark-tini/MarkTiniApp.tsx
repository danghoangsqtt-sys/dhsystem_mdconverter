...
const PdfViewerBox = lazy(() =>
  import('./PdfViewerBox').then((mod) => ({ default: mod.PdfViewerBox }))
);
...
const MarkTiniApp: React.FC = () => {
  ...
  const [wordExportMode, setWordExportMode] = useState<'editable' | null>(null);
